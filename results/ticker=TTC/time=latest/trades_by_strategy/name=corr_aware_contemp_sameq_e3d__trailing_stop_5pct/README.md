...
|---|---|---|---|
| Total Return | 259.6% | 68.9% | -190.7% |
| Annualized Return | 12.2% | 27.7% | — |
...
| Metric | Value | Notes |
|---|---|---|
| HHI | 0.0105 | Ideal for 183 trades: 0.0055 |
| Top-1 Trade | 6.5% of gross profit | Moderate concentration |
| Top-3 Trades | 16.2% of gross profit | Moderate concentration |
| Return ex-Top-1 | 33.8% | Positive without best trade |
| Return ex-Top-3 | -6.3% | Negative without top 3 |
...
|---|---|---|---|---|---|
| direction_right_profit | 71 | 4.79% | 339.8% | 3.17% | 13.31 |
| no_signal | 18 | 2.13% | 38.4% | 1.39% | 9.72 |
| direction_wrong_loss | 94 | -3.18% | -299.2% | -3.27% | 5.57 |
...
|---|---|---|---|---|---|---|
| unknown | 139 | 0.40% | 56.1% | 43.2% | 43.2% | -0.22% |
| weak_negative | 16 | 2.28% | 36.4% | 50.0% | 50.0% | 0.57% |
| regime_shift | 17 | -0.13% | -2.2% | 41.2% | 41.2% | -1.08% |
| strong_negative | 11 | -1.03% | -11.4% | 45.5% | 45.5% | -1.61% |

**Best-performing regime:** `unknown` — 139 trades, 56.1% total return, 43.2% win rate.
**Worst-performing regime:** `strong_negative` — 11 trades, -11.4% total return.
...
**53 trades** where the UCC signal missed the earnings surprise but the correlation flip resulted in a profitable direction.
...
| unknown | 37 | 5.36% |
| regime_shift | 7 | 5.58% |
| strong_negative | 5 | 2.23% |
| weak_negative | 4 | 5.68% |
...
|---|---|---|---|---|---|
| low | 34 | 2.89% | 98.3% | 52.9% | 52.9% |
| no_data | 116 | -0.05% | -6.0% | 41.4% | 41.4% |
| medium | 33 | -0.40% | -13.3% | 42.4% | 42.4% |

## Long vs Short Performance

| Side | Count | Avg Return | Total Return | Win Rate | Direction Accuracy |
|---|---|---|---|---|---|
| LONG | 96 | 0.97% | 93.0% | 45.8% | 45.8% |
| SHORT | 87 | -0.16% | -14.1% | 41.4% | 41.4% |
...
| 2019 | 13 | -12.2% | -0.94% | 46.2% | 46.2% | -21.9% |
| 2020 | 30 | 28.1% | 0.94% | 43.3% | 43.3% | -9.0% |
| 2021 | 21 | 18.4% | 0.88% | 57.1% | 57.1% | 1.0% |
...
**Drawdown:** -56.5% cumulative (trade 119 to trade 162)
**Period:** 2023-09-07 to 2025-04-04 (44 trades)
**Peak cumulative return:** 89.6% → **Trough:** 33.1%
...
|---|---|---|---|---|
| 1-5d | 81 | -1.49% | -120.7% | 28.4% |
| 16-30d | 22 | 4.88% | 107.5% | 86.4% |
| 31-50d | 5 | 10.60% | 53.0% | 100.0% |
| 50d+ | 1 | 11.51% | 11.5% | 100.0% |
| 6-15d | 74 | 0.37% | 27.7% | 43.2% |
...
**Sample size:** 183 trades provides a reasonable sample for most metrics, though tail statistics (max drawdown, streaks) remain noisy.
**Diversification:** Moderate concentration. Returns remain positive excluding top 3 trades (-6.3%).
**Win/loss profile:** Profit factor of 1.24 with 43.7% win rate. Positive in-sample but the margin is thin enough that transaction cost assumptions and execution slippage matter.
**Signal vs Direction:** Signal accuracy (44.2%) and direction accuracy (43.7%) are similar, suggesting the correlation flip had limited net impact in this sample.

### Known Vulnerabilities

- **Worst year:** 2024 (-33.6%, 25 trades). Macro: 2024 Election Year Uncertainty
- **Losing regime:** `regime_shift` — 17 trades, -2.2% total return
- **Losing regime:** `strong_negative` — 11 trades, -11.4% total return
