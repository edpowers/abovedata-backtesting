...
| Top-1 Trade | 11.6% of gross profit | Moderate concentration |
| Top-3 Trades | 27.6% of gross profit | Moderate concentration |
| Return ex-Top-1 | 37.8% | Positive without best trade |
...
|---|---|---|---|---|---|
| direction_right_profit | 23 | 11.26% | 259.1% | 10.52% | 12.43 |
| no_signal | 23 | 0.31% | 7.1% | -1.35% | 8.17 |
| direction_wrong_loss | 26 | -6.24% | -162.2% | -6.46% | 6.46 |
...
|---|---|---|---|---|---|---|
| unknown | 36 | 2.03% | 72.9% | 41.7% | 41.7% | 1.18% |
| weak_negative | 36 | 0.87% | 31.1% | 50.0% | 50.0% | 0.02% |

**Best-performing regime:** `unknown` — 36 trades, 72.9% total return, 41.7% win rate.
...
|---|---|---|---|---|---|
| low | 40 | 2.30% | 92.1% | 45.0% | 45.0% |
| medium | 32 | 0.37% | 11.9% | 46.9% | 46.9% |
...
**Sample size:** 72 trades is a moderate sample. Point estimates may have wide confidence intervals, particularly for Sharpe and drawdown.
**Diversification:** Moderate concentration. Returns remain positive excluding top 3 trades (-14.6%).
**Win/loss profile:** Profit factor of 1.45 with 45.8% win rate. Positive in-sample but the margin is thin enough that transaction cost assumptions and execution slippage matter.
**Signal vs Direction:** Signal accuracy (100.0%) exceeded direction accuracy (45.8%), suggesting the correlation flip occasionally inverted a correct signal. Net impact on returns depends on the magnitude of flip-induced losses vs. flip-induced gains.
