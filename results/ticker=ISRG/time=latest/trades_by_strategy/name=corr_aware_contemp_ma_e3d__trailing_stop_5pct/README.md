# Strategy Analysis: corr_aware_contemp_ma_e3d × trailing_stop_5%

**Ticker:** ISRG
**Entry:** `corr_aware_contemp_ma_e3d`
...
| **Total Trades** | 182 |
| **Win Rate** | 36.8% |
| **Signal Accuracy** | 41.3% |
| **Direction Accuracy** | 38.7% |
| **Skill Ratio** | 38.7% |
| **Profit Factor** | 1.25 |
| **Expectancy** | 0.0048 |
| **Tail Ratio** | 2.13 |
...
|---|---|---|---|
| Total Return | 730.6% | 72.2% | -658.4% |
| Annualized Return | 21.1% | 33.5% | — |
...
|---|---|---|
| HHI | 0.0114 | Ideal for 182 trades: 0.0055 |
| Top-1 Trade | 6.0% of gross profit | ✅ Low concentration |
| Top-3 Trades | 16.5% of gross profit | ✅ Low concentration |
| Return ex-Top-1 | 36.6% | Strategy survives without best trade |
| Return ex-Top-3 | -9.0% | Strategy fails without top 3 |
...
|---|---|---|---|---|---|
| direction_right_profit | 58 | 6.46% | 374.6% | 6.31% | 11.34 |
| no_signal | 32 | -0.54% | -17.3% | -0.21% | 7.16 |
| direction_wrong_loss | 92 | -2.94% | -270.5% | -3.75% | 4.40 |
...
|---|---|---|---|---|---|---|
| strong_negative | 34 | 2.64% | 89.7% | 47.1% | 47.1% | 1.10% |
| strong_positive | 28 | 0.82% | 23.0% | 46.4% | 46.4% | 0.30% |
| weak_negative | 15 | 0.99% | 14.8% | 33.3% | 33.3% | 0.31% |
| regime_shift | 63 | -0.12% | -7.7% | 33.3% | 33.3% | 0.34% |
| unknown | 19 | -0.54% | -10.2% | 36.8% | 36.8% | -1.22% |
| weak_positive | 23 | -0.99% | -22.8% | 21.7% | 21.7% | -1.48% |

**Best regime:** `strong_negative` — 34 trades, 89.7% total return, 47.1% win rate.
...
**43 trades** where the UCC signal missed the earnings surprise but the correlation flip correctly identified the price move.
...
|---|---|---|
| regime_shift | 16 | 3.89% |
| strong_negative | 10 | 6.91% |
| strong_positive | 7 | 5.04% |
...
|---|---|---|---|---|---|
| medium | 116 | 0.82% | 94.6% | 40.5% | 40.5% |
| high | 31 | 0.45% | 14.1% | 32.3% | 32.3% |
...
|---|---|---|---|---|---|
| LONG | 86 | 0.82% | 70.5% | 41.9% | 41.9% |
| SHORT | 96 | 0.17% | 16.3% | 32.3% | 32.3% |
...
| 2022 | 48 | -9.5% | -0.20% | 37.5% | 37.5% | 7.4% |
| 2023 | 23 | 67.0% | 2.91% | 47.8% | 47.8% | 40.5% |
| 2024 | 17 | 23.9% | 1.40% | 41.2% | 41.2% | -0.1% |
| 2025 | 33 | -42.1% | -1.28% | 27.3% | 27.3% | -36.0% |
...
**2025** (Losing year: -42.1%, 33 trades)
...
**Drawdown:** -86.4% cumulative (trade 142 to trade 175)
**Period:** 2024-10-08 to 2025-09-16 (34 trades)
**Peak cumulative return:** 130.6% → **Trough:** 44.2%
...
**Diversification:** Acceptable. Returns survive removal of top 3 trades (-9.0% remaining).
**Signal vs Direction:** Signal accuracy (41.3%) exceeds direction accuracy (38.7%), suggesting the correlation flip occasionally inverts a correct signal. The flip helps more than it hurts overall.
**Regime dependence:** `strong_negative` (34 trades, 19% of total) generates 89.7% — a disproportionate share of returns.

### Known Vulnerabilities

- **Worst year:** 2025 (-42.1%, 33 trades). Macro: 2025 Tariff Escalation, 2025 H2 Recovery
- **Losing regime:** `regime_shift` — 63 trades, -7.7% total return
